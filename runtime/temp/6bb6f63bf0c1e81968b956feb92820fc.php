<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\xampp\htdocs\tp5\public/../application/admin\view\activity\index.html";i:1509421691;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="ibox-content">
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tr class="grade">
                            ...
                            <td>
                                <a target="_self" href="<?php echo url('admin/Activity/mod',['id' => $vo['id']]); ?>">修改</a>
...
<script>
    $(function () {
        ...
        $(".del").click(function () {
            ...
            $.post(
                "<?php echo url('admin/Activity/del'); ?>",
                {aid: aid},
                function (data) {
                    console.log(data);
                    if (data.res == 1) {
                        layer.alert("删除活动现场成功！",{
                            icon: 6,
                            btn: ['确认', '取消'],
                            yes: function() {
                                window.location.href="<?php echo url('admin/Activity/index'); ?>";
                            }
                        });
                    }
                }, "json");
