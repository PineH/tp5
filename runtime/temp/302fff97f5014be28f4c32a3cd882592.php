<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\xampp\htdocs\tp5\public/../application/admin\view\banner\mod.html";i:1509350201;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="ibox-content">
                    <form method="post" action="" enctype="multipart/form-data" class="form-horizontal">
                        <div class="form-group" hidden>
                            ...
                            <div class="col-sm-10">
                                <input type="text"  class="form-control" name="bid" value="<?php echo $data['id']; ?>">
                            </div>
                        </div>
