<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\xampp\htdocs\tp5\public/../application/admin\view\ambient\Ambient_type.html";i:1510207857;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <button class="btn btn-outline btn-link"><a href="<?php echo url('admin/Ambient/Ambient_type_add'); ?>">教学环境分类添加</a></button>
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tr class="grade">
                            ...
                            <td><img src="upload/<?php echo $vo['img_url']; ?>"/></td>
                            ...
                            <td>
                                <a target="_self" href="<?php echo url('admin/Ambient/Ambient_type_mod',['id' => $vo['id']]); ?>">修改</a>
...
<script>
    $(function () {
        $(".del").click(function () {
            ...
            $.post(
                "<?php echo url('admin/Ambient/Ambient_type_del'); ?>",
                {aid: aid},
                function (data) {
                    console.log(data);
                    if (data.res == 1) {
                        layer.alert("删除教学环境分类成功！",{
                            icon: 6,
                            btn: ['确认', '取消'],
                            yes: function() {
                                window.location.href="<?php echo url('admin/Ambient/ambienttype'); ?>";
                            }
                        });
                    }
                }, "json");
