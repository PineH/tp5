<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\xampp\htdocs\tp5\public/../application/admin\view\information\affichemod.html";i:1508490675;}*/ ?>
<!DOCTYPE html>
<html>
...
<script type="text/javascript">
    ...
    $(function () {
        $(".btn-info").click(function () {
            ...
            $.post(
                "<?php echo url('admin/Information/affichemod'); ?>",
                {aid: aid, title: title, content: content, status: status},
                function (data) {
                    console.log(data);
                    if (data.res == 1){
                        layer.alert('修改公告成功！', {
