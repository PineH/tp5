<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\xampp\htdocs\tp5\public/../application/admin\view\banner\index.html";i:1510563616;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="ibox-content">
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tr class="grade">
                            ...
                            <td>
                                <a target="_self" href="<?php echo url('admin/Banner/mod',['id' => $vo['id']]); ?>">修改</a>
