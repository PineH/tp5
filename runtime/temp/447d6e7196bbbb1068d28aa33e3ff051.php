<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\xampp\htdocs\tp5\public/../application/admin\view\information\mod.html";i:1507622514;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="ibox-content">
                    <form method="post" enctype="multipart/form-data" class="form-horizontal">
                        <div class="form-group" hidden>
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="iid" value="<?php echo $data['id']; ?>">
                            </div>
                        </div>
