<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\xampp\htdocs\tp5\public/../application/admin\view\ambient\nindex.html";i:1509421437;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <button class="btn btn-outline btn-link"><a href="<?php echo url('admin/Ambient/nadd'); ?>">教学环境添加</a></button>
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tr class="grade">
                            ...
                            <td>
                                <a target="_self" href="<?php echo url('admin/Ambient/nmod',['id' => $vo['id']]); ?>">修改</a>
...
<script>
    $(function () {
        $(".del").click(function () {
            ...
            $.post(
                "<?php echo url('admin/Ambient/ndel'); ?>",
                {aid: aid},
                function (data) {
                    console.log(data);
                    if (data.res == 1) {
                        layer.alert("删除教学环境成功！",{
                            icon: 6,
                            btn: ['确认', '取消'],
                            yes: function() {
                                window.location.href="<?php echo url('admin/Ambient/nindex'); ?>";
                            }
                        });
                    }
                }, "json");
