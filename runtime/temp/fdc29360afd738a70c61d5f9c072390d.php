<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\xampp\htdocs\tp5\public/../application/admin\view\tape\assistant_mod.html";i:1510565108;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="ibox-content">
                    <form method="post" enctype="multipart/form-data" class="form-horizontal">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">录音棚类型</label>

                            <div class="col-sm-10">
                                <select class="form-control m-b nav_name" name="tape_type">
                                    <?php if(is_array($tape_type) || $tape_type instanceof \think\Collection || $tape_type instanceof \think\Paginator): $i = 0; $__LIST__ = $tape_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tape_type): $mod = ($i % 2 );++$i;?>
                                    <option value="<?php echo $tape_type['id']; ?>"><?php echo $tape_type['title']; ?></option>
