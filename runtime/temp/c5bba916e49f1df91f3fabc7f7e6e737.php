<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\xampp\htdocs\tp5\public/../application/admin\view\tape\assistant.html";i:1510566821;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <button class="btn btn-outline btn-link"><a href="<?php echo url('admin/Tape/tape_assistant_add'); ?>">录音棚图片管理添加</a></button>
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tr class="grade">
                            ...
                            <td><img src="upload/<?php echo $vo['d_img_url']; ?>"/></td>
                            ...
                            <td>
                                <a target="_self" href="<?php echo url('admin/Tape/tape_assistant_mod',['id' => $vo['d_id']]); ?>">修改</a>
...
<script>
    $(function () {
        $(".del").click(function () {
            ...
            $.post(
                "<?php echo url('admin/Banner/del'); ?>",
                {bid: bid},
                function (data) {
                    console.log(data);
                    if (data.res == 1) {
                        layer.alert("删除banner成功！",{
                            icon: 6,
                            btn: ['确认', '取消'],
                            yes: function() {
                                window.location.href="<?php echo url('admin/Banner/index'); ?>";
                            }
                        });
                    }
                }, "json");
