<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\xampp\htdocs\tp5\public/../application/admin\view\twonav\index.html";i:1507799719;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <button class="btn btn-outline btn-link"><a href="<?php echo url('admin/Twonav/add'); ?>">导航添加</a></button>
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tr class="grade">
                            <td><?php echo $vo['two_id']; ?></td>
                            <td><?php echo $vo['two_title']; ?></td>
                            ...
                            <td>
                                <a target="_self" href="<?php echo url('admin/Twonav/mod',['id' => $vo['two_id']]); ?>">修改</a>
                                <a class="del" target="_self" value="<?php echo $vo['two_id']; ?>">删除</a>
                            </td>
                        </tr>
...
<script>
    $(function () {
        $(".del").click(function () {
            ...
            $.post(
                "<?php echo url('admin/Twonav/del'); ?>",
                {tid: tid},
                function (data) {
                    console.log(data);
                    if (data.res == 1) {
                        layer.alert('删除二级导航成功！', {
                            icon: 6,
                            btn: ['确认', '取消'],
                            yes: function() {
