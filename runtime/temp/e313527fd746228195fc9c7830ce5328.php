<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\xampp\htdocs\tp5\public/../application/admin\view\information\affiche.html";i:1507800598;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <button class="btn btn-outline btn-link"><a href="<?php echo url('admin/Information/afficheadd'); ?>">公告添加</a></button>
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tr class="grade">
                            ...
                            <td>
                                <a target="_self" href="<?php echo url('admin/Information/affichemod',['id' => $vo['id']]); ?>">修改</a>
...
<script>
    $(function () {
        $(".del").click(function () {
            ...
            $.post(
                "<?php echo url('admin/Information/affichedel'); ?>",
                {aid: aid},
                function (data) {
                    console.log(data);
                    if (data.res == 1){
                        layer.alert('删除公告成功！', {
                            ...
                            btn: ['确认', '取消'],
                            yes: function() {
                                window.location.href="<?php echo url('admin/Information/affiche'); ?>";
                            }
                        });
                    }
                }, "json");
