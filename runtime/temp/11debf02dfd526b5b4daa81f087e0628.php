<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"D:\xampp\htdocs\tp5\public/../application/admin\view\nav\index.html";i:1507799180;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <button class="btn btn-outline btn-link"><a href="<?php echo url('admin/Nav/add'); ?>">导航添加</a></button>
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tr class="grade">
                            ...
                            <td>
                                <a target="_self" href="<?php echo url('admin/Nav/mod',['id' => $vo['id']]); ?>">修改</a>
