<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\xampp\htdocs\tp5\public/../application/admin\view\ambient\Ambient_type_mod.html";i:1510206552;}*/ ?>
<!DOCTYPE html>
<html>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control m-b" name="two_id">
                                    <?php if(is_array($two_nav) || $two_nav instanceof \think\Collection || $two_nav instanceof \think\Paginator): $i = 0; $__LIST__ = $two_nav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$two_nav): $mod = ($i % 2 );++$i;if($two_nav['two_id'] == $data['ambient_id']): ?>
