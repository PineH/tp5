<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\xampp\htdocs\tp5\public/../application/admin\view\teachers\index.html";i:1510026199;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="ibox-content">
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tr class="grade">
                            ...
                            <td>
                                <a target="_self" href="<?php echo url('admin/Teachers/mod',['id' => $vo['id']]); ?>">修改</a>
...
<script>
    $(function () {
        ...
        $(".del").click(function () {
            ...
            $.post(
                "<?php echo url('admin/Teachers/del'); ?>",
                {tid: tid},
                function (data) {
                    console.log(data);
                    if (data.res == 1) {
                        layer.alert("删除师资力量成功！",{
                            icon: 6,
                            btn: ['确认', '取消'],
                            yes: function() {
                                window.location.href="<?php echo url('admin/Teachers/index'); ?>";
                            }
                        });
                    }
                }, "json");
