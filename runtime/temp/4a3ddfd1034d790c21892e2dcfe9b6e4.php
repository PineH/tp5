<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\xampp\htdocs\tp5\public/../application/admin\view\information\index.html";i:1509420333;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <button class="btn btn-outline btn-link"><a href="<?php echo url('admin/Information/add'); ?>">行业动态添加</a></button>
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tr class="grade">
                            ...
                            <td>
                                <a target="_self" href="<?php echo url('admin/Information/mod',['id' => $vo['id']]); ?>">修改</a>
...
<script>
    $(function () {
        ...
        $(".del").click(function () {
            ...
            $.post(
                "<?php echo url('admin/Information/hydel'); ?>",
                {iid: iid},
                function (data) {
                    console.log(data);
                    if (data.res == 1) {
                        layer.alert('删除行业动态成功！',{
                            icon: 6,
                            btn: ['确认', '取消'],
                            yes: function() {
