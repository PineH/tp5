<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\xampp\htdocs\tp5\public/../application/admin\view\information\recruitmod.html";i:1508491119;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="ibox-content">
                    <form method="" class="form-horizontal">
                        <div class="form-group" hidden>
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control rid" value="<?php echo $data['id']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control job" value="<?php echo $data['job']; ?>">
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    ue.addListener("ready", function () {
        ue.setHeight(350);
        // editor准备好之后才可以使用
        var content     =     '<?php echo $data['job_describe']; ?>';
    ...
    $(function () {
        $(".btn-info").click(function () {
            ...
            $.post(
                "<?php echo url('admin/Information/recruitmod'); ?>",
                {rid: rid, job: job, job_describe: job_describe, address: address, tel: tel, status: status},
                function (data) {
                    console.log(data);
                    if (data.res == 1) {
                        layer.alert('修改招聘成功！', {
