<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\xampp\htdocs\tp5\public/../application/admin\view\information\afficheadd.html";i:1508490640;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="ibox-content">
                    <form method="" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <script id="editor" class="content" type="text/plain"></script>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
    ...
    $(function () {
        $(".btn-info").click(function () {
            ...
            if (title == ''){
                ...
                layer.msg('标题长度应在2-10之间！',function () {
                });
                $(".title").focus();
                return false;
            }
            if(content == ''){
                layer.msg('公告内容不能为空！',function () {
                });
                return false;
            }
            $.post(
                "<?php echo url('admin/Information/afficheadd'); ?>",
