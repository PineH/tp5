<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\xampp\htdocs\tp5\public/../application/admin\view\about\contact.html";i:1507816206;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <button class="btn btn-outline btn-link"><a href="<?php echo url('admin/About/contact_add'); ?>">联系我们添加</a></button>
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tr class="grade">
                            ...
                            <td>
                                <a target="_self" href="<?php echo url('admin/About/contact_mod',['id' => $vo['id']]); ?>">修改</a>
...
<script>
    $(function () {
        $(".del").click(function () {
            ...
            $.post(
                "<?php echo url('admin/About/contact_del'); ?>",
                {cid: cid},
                function (data) {
                    console.log(data);
                    if (data.res == 1) {
                        layer.alert('删除联系我们成功！', {
                            icon: 6,
                            btn: ['确认', '取消'],
                            yes: function() {
