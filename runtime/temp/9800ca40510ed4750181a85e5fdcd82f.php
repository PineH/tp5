<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\xampp\htdocs\tp5\public/../application/admin\view\information\recruit.html";i:1507800847;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <button class="btn btn-outline btn-link"><a href="<?php echo url('admin/Information/recruitadd'); ?>">招聘添加</a></button>
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tr class="grade">
                            ...
                            <td>
                                <?php echo mb_substr(strip_tags($vo['job_describe']),0,10,'utf-8'); ?>
                            </td>
                            ...
                            <td>
                                <a target="_self" href="<?php echo url('admin/Information/recruitmod',['id' => $vo['id']]); ?>">修改</a>
...
<script>
    $(function () {
        $(".del").click(function () {
            ...
            $.post(
                "<?php echo url('admin/Information/recruitdel'); ?>",
                {rid: rid},
                function (data) {
                    console.log(data);
                    if (data.res == 1) {
